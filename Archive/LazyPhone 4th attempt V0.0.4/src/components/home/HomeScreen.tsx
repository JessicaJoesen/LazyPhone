...
type HomeView = "home" | "phone" | "store" | "settings" | "messages";
...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  const openMessages = () => setView("messages");
    ...
    <div className="lp-home">
      ...
      {view === "messages" && (
        <div className="lp-app-screen">
          ...
          <p className="lp-app-body">
            Messages placeholder. In future this could hook into your chat /
            DM / prank reply system.
          </p>
        </div>
      )}
