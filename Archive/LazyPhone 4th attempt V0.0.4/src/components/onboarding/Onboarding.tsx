    ...
    <div className="lp-onboarding">
      {step === 0 && (
        <div className="lp-onboarding-slide">
          ...
          <p>
            Your tiny OS for apps, prank calls, maps and whatever we bolt on next.
          </p>
      ...
      {step === 2 && (
        <div className="lp-onboarding-slide">
          ...
          <p>
            LazyPhone will later talk to your backends, Minecraft, call systems,
            maps and more. For now, it just lives in your browser.
          </p>
          <div className="lp-onboarding-actions">
            <button className="lp-btn ghost" onClick={back}>
              Back
